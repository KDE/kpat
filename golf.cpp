...
bool Golf::checkAdd(const PatPile * pile, const QList<Card*> & oldCards, const QList<Card*> & newCards) const
{
...
bool Golf::checkRemove(const PatPile * pile, const QList<Card*> & cards) const
{
