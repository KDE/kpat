    ...
    if ((which_game == "der_katz") or (which_game == "der_katzenschwantz") or (which_game == "die_schlange")):
        ...
        for card in cards:
            ...
            if (not((which_game == "die_schlange") and ((card & 0x0F) == 1))):
                if (output != ""):
                    output = output + " "        
                output = output + card_to_string(card, 1)
        print output
        ...
        if ((which_game == "forecell") or (which_game == "eight_off")):
            ...
            for i in range(52):
                if (i < 48):
                    output[i%8] = output[i%8] + card_to_string(cards[i], (i>=48-8))
                else:
                    if (which_game == "forecell"):
                        output[8] = output[8] + card_to_string(cards[i], (i == 52))
                    else:
                        output[8] = output[8] + card_to_string(cards[i], 0) + "-"
                        if (i != 52):
                            output[8] = output[8] + " "
        else:
            for i in range(52):
                output[i%8] = output[i%8] + card_to_string(cards[i], (i>=52-8))
        ...
        for i in range(52):
            if (i < 50):
                output[i%10] = output[i%10] + card_to_string(cards[i], (i>=50-10))
            else:
                output[10] = output[10] + card_to_string(cards[i], (i == 52-1))
        ...
        for i in range(52):
            output[i%13] = output[i%13] + card_to_string(cards[i], (i>=52-13))
